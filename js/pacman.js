...
function movePacman(direction) {
	if(PAUSE) resumeGame();
	if((((((PACMAN_POSITION_X == 170 && PACMAN_DIRECTION == 1) || (PACMAN_POSITION_X == 188 && PACMAN_DIRECTION == 3)) && PACMAN_POSITION_Y == 416) ||
		(((PACMAN_POSITION_X == 370 && PACMAN_DIRECTION == 3) || (PACMAN_POSITION_X == 350 && PACMAN_DIRECTION == 1)) && PACMAN_POSITION_Y == 416) ||
		(((PACMAN_POSITION_X == 324 && PACMAN_DIRECTION == 3) || ((PACMAN_POSITION_X == 278) || (PACMAN_POSITION_X == 226 && PACMAN_DIRECTION == 1))) && PACMAN_POSITION_Y == 522) ||
		(((PACMAN_POSITION_Y == 276 && PACMAN_DIRECTION == 4) || (PACMAN_POSITION_Y == 238 && PACMAN_DIRECTION == 2)) && PACMAN_POSITION_X == 422) ||
		(((PACMAN_POSITION_Y == 276 && PACMAN_DIRECTION == 4) || (PACMAN_POSITION_Y == 238 && PACMAN_DIRECTION == 2)) && PACMAN_POSITION_X == 128) ||
		(((PACMAN_POSITION_X == 170 && PACMAN_DIRECTION == 1) || (PACMAN_POSITION_X == 188 && PACMAN_DIRECTION == 3)) && PACMAN_POSITION_Y == 98) ||
		(((PACMAN_POSITION_X == 370 && PACMAN_DIRECTION == 3) || (PACMAN_POSITION_X == 350 && PACMAN_DIRECTION == 1)) && PACMAN_POSITION_Y == 98) ||
		(((PACMAN_POSITION_X == 324 && PACMAN_DIRECTION == 3) || ((PACMAN_POSITION_X == 278) || (PACMAN_POSITION_X == 226 && PACMAN_DIRECTION == 1))) && PACMAN_POSITION_Y == 204)) && PACMAN_MOVING)) {
		if(!PAUSE) pauseGame();
		return;
	}
